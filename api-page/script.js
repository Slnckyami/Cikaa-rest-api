document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        setContent('page', 'textContent', settings.name || "Always Cikaa UI");
        setContent('wm', 'textContent', `© 2025 ${settings.apiSettings.creator}. All rights reserved.` || "© 2025 Always Cikaa");
        setContent('header', 'textContent', settings.name || "Always Cikaa UI");
        setContent('name', 'textContent', settings.name || "Always Cikaa UI");
